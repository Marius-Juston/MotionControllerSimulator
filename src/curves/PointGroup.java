...
import curves.figures.ObservedDirectionalArrow;
import curves.figures.PositionPoint;
...
//		degrees.set(10);
    ...
    getChildren().addAll(arrowRadius, observedDirectionalArrow, positionPoint, name);
  }
  ...
  public double getDegrees() {
    return StrictMath.toDegrees(angleProperty().get());
  }
